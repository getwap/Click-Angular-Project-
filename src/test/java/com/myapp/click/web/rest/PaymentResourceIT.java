...
//        assertThat(testPayment.getCik()).isEqualTo(DEFAULT_CIK);
//        assertThat(testPayment.getCcc()).isEqualTo(DEFAULT_CCC);
//        assertThat(testPayment.getPayment_amount()).isEqualTo(DEFAULT_PAYMENT_AMOUNT);
...
//            .andExpect(jsonPath("$.[*].payment_amount").value(hasItem(DEFAULT_PAYMENT_AMOUNT)))
...
//            .andExpect(jsonPath("$.payment_amount").value(DEFAULT_PAYMENT_AMOUNT))
...
//            .cik(UPDATED_CIK)
//            .ccc(UPDATED_CCC)
//            .payment_amount(Long.valueOf(UPDATED_PAYMENT_AMOUNT))
//            .name(UPDATED_NAME)
//            .email(UPDATED_EMAIL)
//            .phone(UPDATED_PHONE);
//
...
//        Payment testPayment = paymentList.get(paymentList.size() - 1);
//        assertThat(testPayment.getCik()).isEqualTo(UPDATED_CIK);
//        assertThat(testPayment.getCcc()).isEqualTo(UPDATED_CCC);
//        assertThat(testPayment.getPayment_amount()).isEqualTo(UPDATED_PAYMENT_AMOUNT);
...
//
//        partialUpdatedPayment.ccc(UPDATED_CCC).email(UPDATED_EMAIL);
//
//        restPaymentMockMvc
//            .perform(
